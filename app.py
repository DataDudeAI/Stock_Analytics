...
# algorithm = st.selectbox("Select Prediction Algorithm", ['Linear Regression', 'Decision Tree', 'Random Forest', 'XGBoost', 'CatBoost', 'LSTM'])
...
#     else:
#         st.error("Failed to fetch data for visualization.")
